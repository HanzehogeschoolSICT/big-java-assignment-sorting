...
/**
 * Created by peterzen on 2017-03-02.
...
public class ChartDataManager {
    ...
    public ChartDataManager(BarChart initializedBarChart, XYChart.Series<String, Integer> chartData) {
        this(initializedBarChart);
        this.chartDataSeries = chartData;
    }
